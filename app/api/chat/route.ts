...
const SYSTEM_PROMPT = [
  ...
  "",
  "Use this offer during the early-access period: 'You're one of our early users, so the full report's free while I'm improving Mike with real feedback from people using it. If you find it useful, I'd really appreciate a quick review. There's an optional tip too if you want, but absolutely no obligation. Want the full breakdown?'",
  "",
